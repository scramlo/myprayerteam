...
class PrayersControllerTest < ActionController::TestCase
  ...
  test "should create prayer" do
    assert_difference('Prayer.count') do
      post :create, prayer: { answered: @prayer.answered, description: @prayer.description, title: @prayer.title }
    end
  ...
  test "should update prayer" do
    patch :update, id: @prayer, prayer: { answered: @prayer.answered, description: @prayer.description, title: @prayer.title }
    assert_redirected_to prayer_path(assigns(:prayer))
  end
